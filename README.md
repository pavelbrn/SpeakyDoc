...
This container has limited resources so it might take a little while to process a .wav file.
...
The source code for the front end can be found in frontend/speaky-doc-app/src/routes.
